...
::: contact-info
[ulrik.lyngs\@cs.ox.ac.uk](mailto:ulrik.lyngs@cs.ox.ac.uk){.email}\
...
::: interests
**Aims---**to develop and evaluate design patterns that help people self-regulate their use of smartphones and laptops. <br> **Methods---**controlled studies, user surveys, interviews, co-design workshops, web scraping, behaviour logging.
...
<h3>Conference publications <br>[(fully reviewed, archival)]{.review-note}</h3>
:::
...
<h3>Journal articles [(fully reviewed, archival)]{.review-note}</h3>
...
<h3>Extended abstracts and workshop papers <br>[(lightly reviewed)]{.review-note}</h3>
