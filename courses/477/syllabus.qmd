...
Format: [PDF](syllabus.pdf) \| [HTML](syllabus.html)
...
By appointment only via <http://bit.ly/drfurtado-appt>
...
[^2]: Due on Mondays before class - before the content is covered
...
# Class Sequence {#sec-class-sequence}

Click [here to open the course sequence](https://drfurtado.github.io/qacademic/courses/477/sequence.html) - opens in wide view
