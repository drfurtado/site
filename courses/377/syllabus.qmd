...
If you have a question concerning this course (i.e., assignments, content, deadlines, etc.), send a message[^1] to our mailing list (provide under Canvas\>Home). For any other matters, send me a message at my CSUN email.

[^1]: When referring to an assignment, open it online, copy its URL address, and include it as part of your question. Students may also answer questions that are sent to our mailing list.
