...
6.  If you choose to obtain your materials elsewhere you have until \[**date coming soon**\] to Opt-Out (see instructions below). Those who Opt-Out by \[date coming soon\] will lose access and will **not be charged**.
7.  Anyone who does not Opt-Out by the \[**date coming soon**\] deadline will be charged and those charges **will not be reversible**.

### Opt-out Instructions

If you wish to opt out of this program and not purchase access to the required digital materials you will need to follow the steps below by \[**date coming soon**\]:
...
::: callout-important
If you choose to use any object other than the mini juggling balls, then you understand that your performance may be negativelly affected by it. When performing the exchange technique (required for this activity), at a given point, performers need to hold two objects in one hand. This becomes a problem if large objects are being used; i.e., tennis balls.
:::
