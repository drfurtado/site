...
2.  As you practice the skill, use the Motor Learning Principles (APPENDIX C) that will be taught in this course. For example, jugglers use the **Principle of Simplification** when learning to juggle 3 objects:
...
2.  I've put together a tutorial that is meant to help you before and after you start practicing: [click here to access the tutorial](https://canvas.csun.edu/courses/114152/pages/appendix-b-lt-tutorials "Appendix B: LT Tutorials")
...
1.  Pick TWO of the [Principles of Motor Learning](https://canvas.csun.edu/courses/114152/pages/appendix-c-principles-of-motor-learning "Appendix C: Principles of Motor Learning") you have been using to learn your selected motor skill (juggling or speed cut stacking).
