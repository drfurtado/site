---
title: 'Syllabus | KIN 610: Quantitative Analysis of Research in Kinesiology'
...
[Cal State Northridge](https://3dmap.csun.edu/?id=1100#!m/249612)\
Fall 2022\
Meetings: Tuesday, 4:00-6:45 p.m., [Redwood Hall](https://3dmap.csun.edu/?id=1100#!m/233531)\
[Download syllabus as PDF](syllabus.pdf)
...
If you have a question concerning this course (i.e. assignments, content, deadlines, etc.), send a message[^2] to our mailing list (provide under `Canvas` \> `Home`). For any other matters, send me a message at my CSUN email.

[^2]: When referring to an assignment, open it online, copy its URL address, and include it as part of your question. Students may also answer questions that are sent to our mailing list.

Keep it in mind:

1.  All students enrolled in my courses are added to the mailing lists automatically. If you are not receiving emails from the mailing address, then contact [CSUN Help Desk](https://www.csun.edu/it/need-help) to get it fixed.
...
1.  Students could answer their own inquiry by reading the syllabus.
...
If you need to schedule an online meeting, you can do so by visiting this link: [bit.ly/drfurtado-bookme](https://bit.ly/drfurtado-bookme). The details will be provided when the meeting is scheduled via `MS Booking`, including the option to cancel/reschedule a meeting, if needed.

### Late Assignments

Unless you have made previous arrangements, a late assignments will be docked 10% per day (first 4 days) it is late.
...
Plagiarism means using words, ideas, or arguments from another person or source without citation[^3]. Cite all sources consulted to any extent (including material from the internet), whether or not assigned and whether or not quoted directly. For quotations, four or more words used in sequence must be set off in quotation marks, with the source identified.

[^3]: Except for Homeworks. your hand-in assignments must represent your own thoughts (refer to [Academic Dishonesty Policy](#dishonesty) for more information); especially, the information about PLAGIARISM.
...
Please, [click here](sequence.qmd) to view the course sequence.
